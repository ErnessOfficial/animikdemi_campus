    ...
    <div className="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-md border border-[#101021]/10 animate-fade-in my-6">
      ...
      <div className="prose max-w-none text-[#101021]/80 space-y-4">
        ...
        <p className="leading-relaxed">
          Esta subpágina está preparada para albergar el contenido correspondiente al descargo de responsabilidad médica. El contenido detallado será añadido próximamente.
        </p>
        
        {/* Placeholder styling block to show how real text will look */}
        <div className="bg-[#24668e]/5 border-l-4 border-[#24668e] p-4 rounded-r-lg mt-6">
          <p className="text-sm text-[#00385b] font-medium">
            <i className="fas fa-info-circle mr-2"></i> Información Importante
          </p>
          <p className="text-sm text-[#101021]/70 mt-1">
            Los recursos y herramientas proporcionados en esta plataforma tienen un propósito informativo y educativo, y no sustituyen el diagnóstico, asesoramiento o tratamiento médico o psicológico profesional.
          </p>
        </div>
      </div>
    </div>
