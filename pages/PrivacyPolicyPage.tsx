    ...
    <div className="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-md border border-[#101021]/10 animate-fade-in my-6">
      ...
      <div className="prose max-w-none text-[#101021]/80 space-y-4">
        <p className="font-semibold text-lg text-[#00385b]">
          Compromiso con la Privacidad de tus Datos
        </p>
        <p className="leading-relaxed">
          Esta subpágina está preparada para albergar el contenido correspondiente a la política de privacidad de la plataforma. El contenido detallado será añadido próximamente.
        </p>
        
        <div className="bg-[#6e4380]/5 border-l-4 border-[#6e4380] p-4 rounded-r-lg mt-6">
          <p className="text-sm text-[#4c1760] font-medium">
            <i className="fas fa-user-lock mr-2"></i> Privacidad y Seguridad
          </p>
          <p className="text-sm text-[#101021]/70 mt-1">
            Nos tomamos muy en serio la protección de tus datos personales. Toda tu interacción con la plataforma es tratada de manera confidencial de acuerdo con las normativas vigentes de protección de datos.
          </p>
        </div>
      </div>
    </div>
