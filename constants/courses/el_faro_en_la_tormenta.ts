    ...
    // ==========================================================
    {
      ...
      activities: [
        ...
        },
        {
          ...
          cards: [
            { id: 1, matchId: 2, text: 'Tengo que limpiar toda la casa hoy', type: 'limiting' },
            { id: 2, matchId: 1, text: 'Recogeré solo la basura del salón por 5 minutos', type: 'empowering' },
            { id: 3, matchId: 4, text: 'Tengo que hacer la presentación mensual (30 slides)', type: 'limiting' },
            { id: 4, matchId: 3, text: 'Escribiré el esquema de 3 puntos en un post-it', type: 'empowering' },
            { id: 5, matchId: 6, text: 'Debo procesar los 150 correos pendientes', type: 'limiting' },
            { id: 6, matchId: 5, text: 'Responderé solo a los 2 correos urgentes de mi jefe', type: 'empowering' },
            { id: 7, matchId: 8, text: 'Tengo que decidir el futuro de mi vida/proyecto', type: 'limiting' },
            { id: 8, matchId: 7, text: 'Solo necesito decidir qué voy a cenar esta noche', type: 'empowering' },
          ],
        }
      ],
    },
