      ...
      activities: [
        {
          ...
          cards: [
            { id: 1, matchId: 2, text: 'Veo a alguien de mi edad comprando una casa enorme.', type: 'limiting' },
            { id: 2, matchId: 1, text: 'No conozco sus deudas, su herencia ni los sacrificios ocultos tras esa foto.', type: 'empowering' },
            { id: 3, matchId: 4, text: 'Sus vacaciones en Bali hacen ver mi vida miserable.', type: 'limiting' },
            { id: 4, matchId: 3, text: 'Es un viaje de 10 días, los otros 355 días tienen rutinas tan ordinarias como las mías.', type: 'empowering' },
            { id: 5, matchId: 6, text: 'La pareja perfecta en redes celebrando su aniversario.', type: 'limiting' },
            { id: 6, matchId: 5, text: 'Las redes muestran la validación pública, no la calidad de la intimidad privada.', type: 'empowering' },
            { id: 7, matchId: 8, text: 'Siento que ya "se me hizo tarde" para lograr el éxito.', type: 'limiting' },
            { id: 8, matchId: 7, text: 'El éxito es cronológicamente ciego; las líneas de tiempo vitales son inventos culturales, no biológicos.', type: 'empowering' },
          ],
        },
        {
          id: 'm3a2',
