...
// Agrega aquí tus guías y manuales. Solo debes editar este archivo:
// - title: el nombre visible en la lista
// - url: el enlace de descarga (por ejemplo, de Google Drive)
// Guarda y la lista se actualizará automáticamente.
